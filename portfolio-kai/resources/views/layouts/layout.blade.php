...
<body>
<header class="flex z-40 sticky md:relative top-0 justify-center place-items-center">
    <nav class="min-w-full bg-white md:relative xl:min-w-[90%] py-4 px-8 md:py-8 md:px-12 shadow-md">
        ...
        <div class="grid grid-cols-2 w-full place-items-center max-md:hidden">
            <div class="flex flex-row place-items-center justify-self-start">
                <div class="min-w-max">
                    <a href="/"><img alt="logo" class="w-30" src={{asset("images/kai-logo.png")}} ></a>
                </div>
                <div class="min-w-max pl-12 font-bold">
                    <a class="relative group hover:text-[#A8543C] transition-all ease-in-out duration-500 ml-5 before:content-[''] before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-0.5 before:bg-[#A8543C] before:transition-all before:duration-500 before:ease-in-out hover:before:w-full hover:before:left-0"
                       href="">Home</a>
                    <a class="relative group hover:text-[#A8543C] transition-all ease-in-out duration-500 ml-5 before:content-[''] before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-0.5 before:bg-[#A8543C] before:transition-all before:duration-500 before:ease-in-out hover:before:w-full hover:before:left-0"
                       href="">About me</a>
                    <a class="relative group hover:text-[#A8543C] transition-all ease-in-out duration-500 ml-5 before:content-[''] before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-0.5 before:bg-[#A8543C] before:transition-all before:duration-500 before:ease-in-out hover:before:w-full hover:before:left-0"
...
<footer class="bg-black text-white py-8">
    <div class="container mx-auto flex flex-col md:flex-row justify-between px-16">
        <div class="mb-8 md:mb-0">
            <a href="/"><img alt="logo" class="w-[20%] h-auto max-w-full filter invert" src={{asset("images/kai-logo.png")}}></a>
            <h2 class="mt-4 text-white font-bold">Volg mij</h2>
            <div class="flex space-x-4 mt-2">
                <a href="" class="relative flex items-center justify-center w-10 h-10 bg-white rounded-full text-[#A8543C] overflow-hidden group shadow-lg transition-all duration-1000 ease-in-out before:content-[''] before:absolute before:inset-0 before:bg-[#A8543C] before:scale-0 before:transition-all before:duration-500 before:ease-in-out before:rounded-full hover:text-white hover:before:scale-200">
                </a>
                <a href="" class="relative flex items-center justify-center w-10 h-10 bg-white rounded-full text-[#A8543C] overflow-hidden group shadow-lg transition-all duration-1000 ease-in-out before:content-[''] before:absolute before:inset-0 before:bg-[#A8543C] before:scale-0 before:transition-all before:duration-500 before:ease-in-out before:rounded-full hover:text-white hover:before:scale-200">
